...
const app = {
  state: {
    ...
    isRouterViewLoading: true // 【TS:202005191098-资管与机构服务业务群(投资交易事业部)_吴松-框架加载子系统有一段空白期，对用户不够友好，期望增加load】
  },
  getters: {
  ...
  mutations: {
    ...
    ADD_VISITED_VIEWS: (state, view) => {
      if (state.visitedViews.some(v => v.path === view.path)){
        ...
        state.visitedViews[oriIdx].query = view.query
    ...
    LOAD_ROUTER_VIEW(state, isRouterViewLoading) {
      state.isRouterViewLoading = isRouterViewLoading;
    }
  },
  actions: {
